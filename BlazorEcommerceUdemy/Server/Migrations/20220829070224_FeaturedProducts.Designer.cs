...
namespace BlazorEcommerceUdemy.Server.Migrations
{
    ...
    [Migration("20220829070224_FeaturedProducts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorEcommerceUdemy.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorEcommerceUdemy.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorEcommerceUdemy.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("BlazorEcommerceUdemy.Shared.Product", b =>
                {
                    b.HasOne("BlazorEcommerceUdemy.Shared.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("BlazorEcommerceUdemy.Shared.ProductVariant", b =>
                {
                    b.HasOne("BlazorEcommerceUdemy.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorEcommerceUdemy.Shared.ProductType", "ProductType")
                        .WithMany()
